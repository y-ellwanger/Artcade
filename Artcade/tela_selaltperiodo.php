...
$selper = "select * from periodos where id_periodo != 3;";
$qper = mysqli_query($conn,$selper);
echo "
    ...
    <body>
        ...
        <div class = 'container-fluid'>
            <div class='justify-content-center d-flex flex-wrap'>
                <div>
                    <h1 style='text-align:center; margin-top:4vh;margin-bottom:2vh'> Períodos </h1>
                
                    <div>
                        <button onclick='func()' class='botao-padrao'> Novo Período </button>
                    </div>
        ...
        <script>
            function func(){
                window.location.href='tela_inperiodo.php';
            }
        </script>
...
$alte = 1;
$ex = 1;
while($row = mysqli_fetch_assoc($qper)){
    
    echo"
        <div class='container-fluid' style='margin-top:5vh;max-width:133.4vh' >
            <div class='d-flex ranking'>
                <img class='icone' src='".$row['imagem_periodo']."'>
                <p  style='margin-left:25px;width:100%;text-align:center'>".$row['nome_periodo']."</p>
                <div>
    ...
    function alterar$alte(){
        document.cookie = 'id_peri = ".$row['id_periodo']."';
        window.location.href = 'tela_altperiodo.php';
        
    }
    function excluir$ex(){
        document.cookie = 'id_peri = ".$row['id_periodo']."';
        window.location.href = 'experiodo.php';
