...
<nav class="navbar navbar-expand" style="background-color:#B37549">
    ...
    <div style="margin-top:70px">
        <div class="d-flex justify-content-center">
            <div>
                <h1 class="d-flex justify-content-center subtitulo">Exclusão de conta</h1>
                <form method="POST" action="exclusao.php" style="width:500px">
                    <div class="form-group">
                        <input type="password" class="form-control form-control-lg" id="senha" name="senha" placeholder="Senha">
                    </div>
                    <button type="submit" class="botao-padrao" style="width:100%">Excluir</button>
                </form>
                AVISO: A exclusão apagará todos os seus dados permanentemente
            </div>
        </div>
    </div>
