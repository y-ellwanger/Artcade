...
<nav class="navbar navbar-expand" style="background-color:#B37549">
    ...
    <div style="margin-top:70px">
        <div class="d-flex justify-content-center">
            <div>
                <h1 class="d-flex justify-content-center subtitulo">Inserir Período</h1>
                <form method="POST" action="inperiodo.php" style="width:500px" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" id="nome" name="nome_periodo" placeholder="Nome do periodo">
                    </div>
                    <div class="form-group">
                        <label for="imagem">Insira o arquivo de imagem do período:</label>
                        <input name="imagem_periodo" id="imagem" type="file">
                    </div>
