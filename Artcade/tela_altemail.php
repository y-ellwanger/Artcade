...
<nav class="navbar navbar-expand" style="background-color:#B37549">
    ...
    <div style="margin-top:70px">
        <div class="d-flex justify-content-center">
            <div>
                <h1 class="d-flex justify-content-center subtitulo">Alteração de E-mail</h1>
                <form method="POST" action="altemail.php" style="width:500px">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" id="email" name="novoemail" placeholder="Novo e-mail">
                    </div>
                    <div class="form-group">
