...
<body style="overflow: hidden">
    ...
    <div style="margin-top:70px">
        <div class="d-flex justify-content-center">
            <div>
                <h1 class="d-flex justify-content-center subtitulo">Registro</h1>
                <form method="POST" action="cadastro.php" style="width:500px">
                ...
                <a href="tela_login.php" class="d-flex justify-content-center texto-sutil" style="color:black"> Já possuo conta </a>
            </div>
        </div>
    </div>
