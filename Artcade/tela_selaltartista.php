...
$selart = "select * from artistas inner join periodos on artistas.fk_periodo = periodos.id_periodo;";
$qart = mysqli_query($conn,$selart);
echo "
    ...
    <body>
        ...
        <div class = 'container-fluid'>
            <div class='justify-content-center d-flex flex-wrap'>
                <div>
                    <h1 style='text-align:center; margin-top:4vh;margin-bottom:2vh'> Artistas </h1>
                
                    <div>
                        <button onclick='func()' class='botao-padrao'> Novo Artista </button>
                    </div>
        ...
        <script>
            function func(){
                window.location.href='tela_inartista.php';
            }
        </script>
...
$alte = 1;
$ex = 1;
while($row = mysqli_fetch_assoc($qart)){
    
    echo"
        <div class='container-fluid' style='margin-top:5vh;max-width:133.4vh' >
            <div class='d-flex ranking'>
                <img class='icone' src='".$row['imagem_artista']."'>
                <p  style='margin-left:25px;width:100%'>".$row['nome_artista']."</p>
                <p  style='width:100%;text-align:center'> ".$row['nome_periodo']." </p>  
                <div>
    ...
    function alterar$alte(){
        document.cookie = 'id_art = ".$row['id_artista']."';
        window.location.href = 'tela_altartista.php';
        
    }
    function excluir$ex(){
        document.cookie = 'id_art = ".$row['id_artista']."';
        window.location.href = 'exartista.php';
