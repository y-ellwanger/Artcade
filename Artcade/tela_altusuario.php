...
if (isset($_COOKIE['id_usuario'])){
    $qusu = mysqli_query($conn,"select * from usuarios where id_usuario=".$_COOKIE['id_usuario'].";");
    $fusu = mysqli_fetch_assoc($qusu);
}
else header('Location: tela_selaltusuario.php');
?>
<DOCTYPE!>
<html>
...
<nav class="navbar navbar-expand" style="background-color:#B37549">
    ...
    <div style="margin-top:70px">
        <div class="d-flex justify-content-center">
            <div>
                <h1 class="d-flex justify-content-center subtitulo">Alterar Usuário</h1>
                <p class='texto-sutil'>Nome de usuário atual: <?php echo $fusu['nome_usuario'] ?></p>
                <p class='texto-sutil'>E-mail atual: <?php echo $fusu['email_usuario'] ?></p>
                <form method="POST" action="altusuario.php" style="width:500px" enctype="multipart/form-data">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" id="nome" name="nome" placeholder="Novo nome">
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" id="email" name="email" placeholder="Novo e-mail">
                    </div>
                    <div class="form-group">
